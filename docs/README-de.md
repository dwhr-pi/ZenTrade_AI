...
- optional [MongoDB](https://www.mongodb.com/) fuer den klassischen Datenbankbetrieb

Fuer lokale Tests und erste Pilotlaeufe gibt es jetzt auch einen dokumentierten CSV-Betrieb ohne MongoDB:
...
Wenn MongoDB in Ihrer Umgebung Probleme macht, koennen Sie stattdessen den CSV-Betrieb verwenden:
...
Fuer vollstaendig lokale Tests ohne echte Boerse ist jetzt auch der Selector `stub.BTC-USD` dokumentiert:

...
Es gibt aktuell zwei sinnvolle Betriebswege:

- klassisch mit MongoDB
- lokal und testorientiert mit CSV-Dateibackend

Die CSV-Variante ist besonders nuetzlich, wenn MongoDB in der Zielumgebung Probleme macht.

Wichtige Projektgrenze vorab:

- `Trading_Analysis.md`
- `docs/trading-risiken-und-grenzen-de.md`
...
Wenn Sie **ohne MongoDB** arbeiten moechten, lesen Sie vor dem ersten Start:

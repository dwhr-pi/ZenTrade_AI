...
export default function AutoTradingIcon({ size = 48, className = "", title = "AutoTradingIcon" }) {
  return (
    <svg
...
<path className="line" d="M126 342h260"/>
<path className="line2" d="M156 322l58-74 54 40 88-122"/>
<path className="line" d="M150 278v44M214 226v96M268 260v62M356 174v148"/>
<path className="line2" d="M326 166h34v34"/>
    </svg>
  );
}

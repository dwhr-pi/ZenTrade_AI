...
export default function MarketScanIcon({ size = 48, className = "", title = "MarketScanIcon" }) {
  return (
    <svg
...
<path className="line" d="M120 256h272M256 120v272"/>
<circle className="line2" cx="256" cy="256" r="92"/>
<path className="line2" d="M202 286l32-56 42 30 42-76"/>
<path className="line" d="M184 332h144"/>
    </svg>
  );
}

...
export default function Continuous247Icon({ size = 48, className = "", title = "Continuous247Icon" }) {
  return (
    <svg
...
<path className="line" d="M158 260c54-90 142-90 196 0-54 90-142 90-196 0z"/>
<path className="line2" d="M158 260c54 90 142 90 196 0"/>
<text className="txt" x="256" y="395" font-size="42" text-anchor="middle">24/7</text>
    </svg>
  );
}

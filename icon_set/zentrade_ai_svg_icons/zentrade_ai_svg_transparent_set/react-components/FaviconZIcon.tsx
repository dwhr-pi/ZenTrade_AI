...
export default function FaviconZIcon({ size = 48, className = "", title = "FaviconZIcon" }) {
  return (
    <svg
...
<path className="line" d="M148 148h216L210 312h154"/>
<path className="line2" d="M178 364h156"/>
<circle className="ring" cx="256" cy="256" r="170"/>
    </svg>
  );
}

...
export default function ZentradeAiBrandIconIcon({ size = 48, className = "", title = "ZentradeAiBrandIconIcon" }) {
  return (
    <svg
...
<circle className="ring" cx="256" cy="190" r="120"/>
<path className="line" d="M180 230c20-54 132-54 152 0"/>
<path className="line2" d="M205 176c18-30 84-30 102 0"/>
<circle className="fill" cx="214" cy="206" r="10"/>
<circle className="fill2" cx="298" cy="206" r="10"/>
<path className="line" d="M160 330h192l-86 70h102"/>
<text className="txt" x="256" y="455" font-size="36" text-anchor="middle">ZEN AI</text>
    </svg>
  );
}

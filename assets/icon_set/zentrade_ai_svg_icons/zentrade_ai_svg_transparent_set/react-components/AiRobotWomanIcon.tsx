...
export default function AiRobotWomanIcon({ size = 48, className = "", title = "AiRobotWomanIcon" }) {
  return (
    <svg
...
<circle className="ring" cx="256" cy="166" r="104"/>
<path className="line" d="M172 180c14-70 154-70 168 0"/>
<path className="line2" d="M204 238c32 28 72 28 104 0"/>
<circle className="fill" cx="216" cy="190" r="12"/>
<circle className="fill2" cx="296" cy="190" r="12"/>
<path className="line" d="M150 282c48 68 164 68 212 0"/>
<path className="line2" d="M128 410c34-78 222-78 256 0"/>
<path className="line" d="M126 168h-36v74h40"/>
<path className="line2" d="M386 168h36v74h-40"/>
    </svg>
  );
}

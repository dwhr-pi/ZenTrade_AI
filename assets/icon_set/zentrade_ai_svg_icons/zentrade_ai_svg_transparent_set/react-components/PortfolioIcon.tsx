...
export default function PortfolioIcon({ size = 48, className = "", title = "PortfolioIcon" }) {
  return (
    <svg
...
<path className="line" d="M256 122v134l116 68"/>
<path className="line2" d="M256 122a134 134 0 1 1-116 202"/>
<path className="line" d="M140 324a134 134 0 0 1 116-202"/>
<path className="line2" d="M256 256h134"/>
    </svg>
  );
}

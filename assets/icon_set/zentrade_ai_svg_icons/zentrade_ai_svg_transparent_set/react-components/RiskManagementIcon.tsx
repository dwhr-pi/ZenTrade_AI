...
export default function RiskManagementIcon({ size = 48, className = "", title = "RiskManagementIcon" }) {
  return (
    <svg
...
<path className="line" d="M256 112l126 48v92c0 86-52 130-126 158-74-28-126-72-126-158v-92z"/>
<rect className="line2" x="204" y="242" width="104" height="82" rx="14"/>
<path className="line" d="M226 242v-32c0-38 60-38 60 0v32"/>
<circle className="fill2" cx="256" cy="284" r="9"/>
    </svg>
  );
}

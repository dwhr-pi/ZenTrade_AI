...
export default function AiAnalyticsIcon({ size = 48, className = "", title = "AiAnalyticsIcon" }) {
  return (
    <svg
...
<path className="line" d="M170 270c-36-76 42-138 86-86 44-52 122 10 86 86-24 54-92 64-86 116 6-52-62-62-86-116z"/>
<circle className="fill" cx="210" cy="242" r="8"/>
<circle className="fill2" cx="256" cy="210" r="8"/>
<circle className="fill" cx="304" cy="242" r="8"/>
<path className="line2" d="M210 242l46-32 48 32M210 242l46 78 48-78"/>
    </svg>
  );
}

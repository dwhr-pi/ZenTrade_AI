...
export default function SettingsIcon({ size = 48, className = "", title = "SettingsIcon" }) {
  return (
    <svg
...
<circle className="line" cx="256" cy="256" r="54"/>
<path className="line2" d="M256 112v56M256 344v56M112 256h56M344 256h56M154 154l40 40M318 318l40 40M358 154l-40 40M194 318l-40 40"/>
    </svg>
  );
}

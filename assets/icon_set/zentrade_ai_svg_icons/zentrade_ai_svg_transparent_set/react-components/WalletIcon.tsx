...
export default function WalletIcon({ size = 48, className = "", title = "WalletIcon" }) {
  return (
    <svg
...
<rect className="line" x="126" y="176" width="260" height="170" rx="30"/>
<path className="line2" d="M126 218h260"/>
<rect className="line2" x="286" y="242" width="100" height="74" rx="22"/>
<circle className="fill" cx="326" cy="279" r="10"/>
<path className="line" d="M210 300c24 18 68 18 92 0"/>
    </svg>
  );
}
